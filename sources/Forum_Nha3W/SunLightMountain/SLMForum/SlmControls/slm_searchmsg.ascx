<%@ Control Language="C#" AutoEventWireup="true" CodeFile="slm_searchmsg.ascx.cs" Inherits="SlmControls_slm_searchmsg" %>
...
<table cellpadding="0" cellspacing="0" class="tblreg">
    <tr>
        <td class="regtd1">
            ...
            <span class="RedLink2"><%= LoadSLMF("SLMF_SearchPro", "Result")%></span>
        </td>
    </tr>
    <tr>
        <td class="regtd2"></td>
    ...
    <tr>
        <td class="tblforum">
            <table cellpadding="0" cellspacing="1" class="forum" >
                <tr>
                    <td class="hforum1" align="center"><%= LoadSLMF("SLMF_SearchPro", "Result")%></td>
                </tr>
                <tr class="forumshow">
                    <td height="57">
                        &nbsp;&nbsp;<%= LoadSLMF("SLMF_SearchPro", "Follow")%><asp:TextBox ID="txtSearch" runat="server" CssClass="reg2txtUserName"></asp:TextBox> 
                        <%= LoadSLMF("SLMF_SearchPro", "At")%> 
                        <asp:DropDownList ID="ddlForum" CssClass="fontmsg" runat="server" ></asp:DropDownList> 
                    ...
                    <ItemTemplate>
                        <tr class="forumshow">
                            ...
                            <td class="ForumDescript">
                                <a href='<%# "showtopic.aspx?rowid=" + RowId(int.Parse(Eval("MessageId").ToString())) + "&messageid=" + Eval("MessageId") + "#message" + Eval("MessageId") %>' class="TitleLnk" ><%# Eval("Title") %></a>
                            </td>
                            <td class="forumshow1" >
                            ...
                            <td class="forumtocpic">
                                ...
                                <a title='<%= LoadSLMF("SLMF_Forum", "GoToNewPost") %>' href='<%# "showtopic.aspx?rowid=" + RowId(int.Parse(Eval("MessageId").ToString())) + "&messageid=" + Eval("MessageId") + "#message" + Eval("MessageId")%>' class="TopicLink" target="_blank"><img src="SlmImages/icon_latest_reply.gif" class="imgBorderW" /></a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
