...
<script runat="server">
	...
	private bool CheckAuthentication()
	{
        ...
        HttpCookie AdminsCookie = Request.Cookies.Get("C2CAdmin");
        //HttpCookie AdminsCookie = new HttpCookie("C2CAdmin");
		//AdminsCookie = Request.Cookies["C2CAdmin"];
        bool bolAuthorized = false;
	    if (AdminsCookie != null)
	    {
			//AdminsCookie = new HttpCookie("C2CAdmin");
		    //lblUserName.Text = AdminsCookie.Value.ToString();
            bolAuthorized = true; 
		}
		else
		{
            bolAuthorized = false; 
		    //Response.Redirect("LoginPanel.aspx?ReturnUrl=/Code4Sale/AdminPanel/Default.aspx");
		}
		return bolAuthorized;
	}
