...
namespace SLMF.Business
{
    public class BServer
    {
        ...
        {
            Insert(cacheName, obj, null, DateTime.Now.AddSeconds(60));
        }
        ...
        public static void Insert(string cacheName, object obj, string cacheKey)
        {
            ...
            Insert(cacheKey, listName, null, DateTime.Now.AddSeconds(60));
        }
        ...
        public static void Insert(string cacheName, object obj, CacheDependency dep, DateTime dt)
        {
            ...
            HttpContext.Current.Cache.Insert(cacheName, obj, dep, dt, TimeSpan.Zero);
        }
