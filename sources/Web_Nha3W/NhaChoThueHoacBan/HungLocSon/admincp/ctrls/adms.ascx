<%@ Control Language="C#" AutoEventWireup="true" CodeFile="adms.ascx.cs" Inherits="admincp_ctrls_adms" %>
...
<div class="ph4">
    ...
    <br /><br />
    <asp:GridView ID="gCities" Width="99%" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="10" DataKeyNames="MemberId,GroupId" BorderColor="#B3C5D8" BorderStyle="Solid" BorderWidth="1px" OnSelectedIndexChanged="gCities_SelectedIndexChanged" OnPageIndexChanging="gCities_PageIndexChanging">
        <Columns>
    ...
    <asp:DropDownList CssClass="nwf" ID="ddlModers" runat="server" DataTextField="DG" DataValueField="GroupId"></asp:DropDownList>&nbsp;
    <asp:Button CssClass="lsp2" ID="Update" runat="server" Text="Add" OnClick="Update_Click" /><br /><br />
    <asp:GridView ID="gCities2" Width="98%" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="30" DataKeyNames="MemberId,GroupId" OnRowDeleting="gCities2_RowDeleting" >
        <Columns>
            ...
            <asp:TemplateField HeaderText="User">
                ...
                <ItemTemplate>
                    <asp:Label ID="lbl3" runat="server" Text='<%# Bind("UserName") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Height="25px" HorizontalAlign="Center" VerticalAlign="Middle" />
                <ItemStyle Font-Names="Tahoma" Font-Size="12px" HorizontalAlign="Left" VerticalAlign="Middle"
                    Width="20%" />
            ...
            <asp:TemplateField HeaderText="Descriptions">
                ...
                <ItemTemplate>
                    <asp:Label ID="lbl3" runat="server" Text='<%# Bind("Descriptions") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle Height="25px" HorizontalAlign="Center" VerticalAlign="Middle" />
                <ItemStyle Font-Names="Tahoma" Font-Size="12px" HorizontalAlign="Left" VerticalAlign="Middle"
                    Width="20%" />
