<%@ Control Language="C#" AutoEventWireup="true" CodeFile="projects.ascx.cs" Inherits="admincp_ctrls_projects" %>
<div class="ph1"><img src="~/images/bgl.png" alt=""/></div>
<div class="ph3">Dự án</div>
...
<div class="ph4">
    ...
    <br /><br />
    Dự án : <input id="txtProjectName" class="lsp" type="text" runat="server"/> <asp:Button CssClass="lsp2" ID="submit" runat="server" Text="Submit" OnClick="submit_Click" />
    <br /><br />
    <asp:GridView ID="gCities" Width="99%" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="30" DataKeyNames="ProjectId,DistrictId,CityId" BorderColor="#B3C5D8" BorderStyle="Solid" BorderWidth="1px" OnRowDeleting="gCities_RowDeleting" OnRowCancelingEdit="gCities_RowCancelingEdit" OnRowEditing="gCities_RowEditing" OnRowDataBound="gCities_RowDataBound" OnRowUpdating="gCities_RowUpdating" OnPageIndexChanging="gCities_PageIndexChanging" >
        <Columns>
            ...
            <asp:TemplateField HeaderText="Tên Dự án">
                <EditItemTemplate>
                    <asp:TextBox ID="txtProjectName2" runat="server" Text='<%# Bind("ProjectName") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
