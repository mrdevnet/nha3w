<%@ Control Language="C#" AutoEventWireup="true" CodeFile="fpms.ascx.cs" Inherits="ctrls_fpms" %>
...
<asp:DataList ID="dtlPMS" runat="server" Width="780px" DataKeyField="PmId" OnItemCommand="dtlPMS_ItemCommand" >
    <ItemTemplate>
        <div class="sms_content">
            ...
            <div class="sms_item_img">
                <a href='<%#Eval("ToMemberId","default.aspx?m={0}")%>'>
            ...
            <div><%--<asp:LinkButton ID="btndelpm" runat="server" CssClass="sms_item_del" CommandArgument='<%#Eval("PmId")%>' CommandName="btndelpm"></asp:LinkButton>--%>
        </div>
        </div>
    </ItemTemplate>
    <ItemStyle Width="780px" />
    <HeaderTemplate>
        <div style="padding-left:10px;"><h2>Tin nhắn đã gửi</h2></div>
        <div class="sms_menu">
        ...
        <div class="sms_menubt">Chọn: <asp:LinkButton ID="btnasl" runat="server" CommandName="btnasl">Tất cả</asp:LinkButton>,
